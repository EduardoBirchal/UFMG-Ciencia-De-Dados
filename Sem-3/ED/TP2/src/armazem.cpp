...
Armazem::Armazem(int id_armazem, int custo_remocao, Escalonador *esc) : id(id_armazem), custoRemocao(custo_remocao), escalonador(esc), secoes(true), pilhaAuxiliar(false)
{
    if (!escalonador)
